...
\section{Dataset Description} \label{sec:appendix-1}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=\linewidth]{conc_vprofile_test.png}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=\linewidth]{conc_sdist_2012.png}
...
\section{Model Architecture} \label{sec:appendix-2}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=\linewidth]{train_test_years.png}
...
\section{Ablation Study}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.5\linewidth]{ablation_study.png}
