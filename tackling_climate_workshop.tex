...
\section{Results} \label{sec:appendix-3}
    ...
    \begin{table}[htbp]
        \centering
        \caption{Atmospheric pressure levels and their corresponding pressure values (hPa) used in this study.}
