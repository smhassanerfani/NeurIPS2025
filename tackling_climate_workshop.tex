...
\author{%
    Mohammad H. Erfani\thanks{Corresponding author (\texttt{smhassan.erfani@gmail.com})} \\
...
\section{Methodology}
    ...
    \subsection{Model Architecture}
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.7\linewidth]{figs/model_architecture.png}
...
\section{Results}
    ...
    \subsection{BCB Global Average Over Time} \label{sec:result-scatter}
        Figures~\ref{fig:global_average_2020} and~\ref{fig:global_average_2021} compare the global average BCB concentrations predicted by the ML model against corresponding ground truth values for 2020 and 2021, respectively (equivalent results for 1853 and 2012 are provided in Appendix~\ref{sec:appendix-2}). The analysis focuses on 2020 and 2021 to evaluate the model's predictive performance on years entirely outside the training domain. Furthermore, 2021 represents one of the most extreme cases of BCB concentration, exhibiting unprecedentedly high values. This comparison evaluates three distinct pressure levels: Level-1 (979 hPa), Level-10 (888.5 hPa), and Level-20 (656 hPa).
...
\section{Results} \label{sec:appendix-2}
    % TODO: add discussion
